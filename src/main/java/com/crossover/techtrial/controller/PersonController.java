...
public class PersonController {
  ...
  /**
   * Bug Fix: perso-id was passed as getMapping URI but it should be person-id same as pathVariable
   * Corrected the same.Test Case is also provided for the same
   */
